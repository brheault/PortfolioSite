...
const skills = [
    ...
    {name: "C#", level: 95, category: "scripting"}
]

const categories = ['all', 'frontend', 'backend', 'scripting', 'tools'];
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-12">
                    {categories.map((category, key) => (
                        <button 
                            ...
                            className={cn("px-5 py-2 rounded-full transition-colors curation-300 capitalize",
